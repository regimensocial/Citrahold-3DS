/*
  ...
  This specific certificate is valid
    Not Before: SOME TIME IN 2015
    Not After : JUNE 2035

  It will need to be replaced before 2035, and the project must
  be rebuilt and reinstalled on all devices.
*/

// THESE ARE MANUALLY ADDED AND MUST BE UPDATED WHEN THE CERTIFICATE IS REPLACED
const int YEAR_EXPIRY = 2035;
const int MONTH_EXPIRY = 6;
// 
...
unsigned int __lets_encrypt_rootca_pem_len = 1970;
